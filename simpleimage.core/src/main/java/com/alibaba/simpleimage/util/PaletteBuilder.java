...
public class PaletteBuilder {
     ...
     * @throws UnsupportedOperationException if implemented method is unable to create approximation of
     ...
     *
     * @throws IllegalArgumentException      if <code>img</code> is <code>null</code>.
     * @throws UnsupportedOperationException if implemented method is unable to create approximation of
